 ...
 *  
 */
function hook_taxonomy_tree_alter(&$tree) {
 ...
 */
function hook_active_tid_alter(&$tid) {
  // Add support for a custom page we have defined in our Drupal setup, for example
  // with Views: www.site.com/custom/page/tid
